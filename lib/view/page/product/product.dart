...
import 'package:kas_mini_flutter_app/utils/navigation_utils.dart';
...
import 'package:kas_mini_flutter_app/view/page/product/add_product.dart';
import 'package:kas_mini_flutter_app/view/page/product/select_category.dart';
import 'package:kas_mini_flutter_app/view/page/product/update_product.dart';
...
import 'package:kas_mini_flutter_app/view/widget/createCategoryModal.dart';
  ...
  Future<void> _pullRefresh() async {
    ...
    setState(() {
      ...
      _futureProducts = (_tabController.index == 0)
          ...
          : null;
      _futureCategories = (_tabController.index != 0) ? fetchCategories() : null;
        });
  }
                                                          ...
                                                          Text(
                                                            product.categoryName !=
                                                                    ...
                                                                    product.categoryName!
                                                                            .length >
                                                                        15
                                                                ? "${product.categoryName?.substring(0, 15)}..."
                                                                : product
                                                                        .categoryName ??
                                                                    "Unknown Category",
                                                            style: TextStyle(
